...
**
** Created: Mon Oct 31 21:40:13 2011
...
static const char qt_meta_stringdata_DrawWidget[] = {
    "DrawWidget\0\0isSaved\0updatesSaved(bool)\0"
    "x,y\0printCoords(int,int)\0"
};
...
int DrawWidget::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: updatesSaved((*reinterpret_cast< bool(*)>(_a[1]))); break;
        case 1: printCoords((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2]))); break;
        default: ;
        }
        _id -= 2;
    }
...
// SIGNAL 0
void DrawWidget::updatesSaved(bool _t1)
{
...
// SIGNAL 1
void DrawWidget::printCoords(int _t1, int _t2)
{
